...
protocol MarvelHerosNavigationControllerProtocol {
    ...
    ///   - animated: with animation
    ///   - completion: completion handler
    ///    Return the object of MarvelHerosNavigationControllerProtocol which can be used to perform next push/present transmisions
    /// Returned MarvelHerosNavigationControllerProtocol needs to be persisted.
    func presentWithNavigator(viewController: UIViewController,
                              modalPresentationStyle: UIModalPresentationStyle,
                              completion: (() -> Void)?) -> MarvelHerosNavigationControllerProtocol
...
/// Custome MarvelHerosNavigationController which is subclass of UINavigationController
final class MarvelHerosNavigationController: UINavigationController {
...
/// MarvelHerosNavigationControllerProtocol
extension MarvelHerosNavigationController: MarvelHerosNavigationControllerProtocol {
    ...
    func presentWithNavigator(viewController: UIViewController,
                              modalPresentationStyle: UIModalPresentationStyle,
                              completion: (() -> Void)?) -> MarvelHerosNavigationControllerProtocol {
        let newNavigationController = MarvelHerosNavigationController(rootViewController: viewController)
...
extension MarvelHerosNavigationController: UINavigationControllerDelegate {
